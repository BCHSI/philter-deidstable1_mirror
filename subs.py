...
class Subs:
    ...
    def get_dob(self, note_id):
        try:
            dob = self.dob_table***REMOVED***note_id***REMOVED***
        except KeyError as err:
    ...
    def get_deid_dob(self, note_id):
        try:
            deid_dob = self.deid_dob_table***REMOVED***note_id***REMOVED***
        except KeyError as err:
    ...
    def get_deid_91_bday(self, note_id):
        try:
            deid_91_bday = self.deid_91_bday_table***REMOVED***note_id***REMOVED***
        except KeyError as err:
    ...
    def _load_look_up_table(self, look_up_table_path):
        ...
        deid_91_bday_table = look_up_table***REMOVED***~look_up_table***REMOVED***"deid_turns_91_date"***REMOVED***.isnull()***REMOVED***
