...
def go_through_xml_files(directory,output_directory):
	...
	output_record_of_date_shifting.columns = ***REMOVED***"Filename", "Input Date", "Shifted Date","Time Delta"***REMOVED***
...
def shift_dates(filename_dates,filename,shift_dates_together,xmlstr,date,output_record_of_date_shifting,verbose):
    ...
    output_record_of_date_shifting = output_record_of_date_shifting.append(***REMOVED***(filename,date,output_shifted_date,time_delta_str)***REMOVED***)
