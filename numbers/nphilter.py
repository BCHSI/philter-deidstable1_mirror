...
class NPhilter:
    ...
    def eval(self,
        ...
        json.dump(summary***REMOVED***"false_negatives"***REMOVED***, open("data/phi/phi_fn.json", "w"), indent=4)
        json.dump(summary***REMOVED***"false_positives"***REMOVED***, open("data/phi/phi_fp.json", "w"), indent=4)
    ...
    def mapphi(self, 
        ...
        for w in d:
            ...
            if word not in phi_map:
                phi_map***REMOVED***word***REMOVED*** = 0
            phi_map***REMOVED***word***REMOVED*** += 1
