...
And here is ***REMOVED***the change-log***REMOVED***(https://github.com/pauliwog/philter-ucsf/blob/master/paul/CHANGE-LOG.md) which should have everything I added or modified.
