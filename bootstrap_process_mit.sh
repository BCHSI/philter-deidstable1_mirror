...
do
	...
	then # run bootstrap	
		bootstrap_name='randomtrainbatch500_20180720_bootstrap'$i
		source_dir='/data/muenzenk/batch_data/randomtrainbatch500_20180720_updated'

		# Make directories to hold inputs/outputs
		bootstrap_dir='/data/muenzenk/bootstrap_data/randomtrainbatch500_20180720_tests/'$bootstrap_name
		mkdir $bootstrap_dir
		...
		nohup python3 main.py -f /data/muenzenk/de-id_stable1/configs/ucsf_pipeline20.json -a $anno_dir -x /data/muenzenk/batch_data/randomtrainbatch500_20180720_updated/phi_notes_rtb20180720.json -i $notes_dir -o $results_dir -c $coord_path --ucsfformat True --stanfordner /data/muenzenk/stanford-ner/ > '/data/muenzenk/bootstrap_data/randomtrainbatch500_20180720_tests/results/'$bootstrap_name'_results.txt' 2>&1 &
        counter=$((counter+1))
