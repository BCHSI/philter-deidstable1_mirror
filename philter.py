...
class Philter:
    ...
    def eval(self,
        ...
        if self.debug:
            ...
            total_phi_count = summary["total_false_negatives"] + summary["total_true_positives"]
        ...
        if self.errorcheck:
            ...
            print('\n')
            print("Corrected Overall Recall: " + "{:.2%}".format(corrected_recall) + " TP: " + str(include_dict['tps']) + " FN: " + str(include_dict['fns']))
            print('\n')
