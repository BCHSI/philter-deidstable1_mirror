...
class Phitexts:
    ...
    def print_log(self, kp, mongo, xml):
        ...
        for filename in self.filenames:
            ...
            #print('length of columns', len(csv_summary_df.columns), 'columns', csv_summary_df.columns)
            s2 = pd.DataFrame([[filename,
                                                              self.batch,
                                                              str(filesize),
                                                              str(total_tokens),
                                                              str(phi_tokens),
            ...
            csv_summary_df = pd.concat([csv_summary_df, s2], ignore_index=True)
