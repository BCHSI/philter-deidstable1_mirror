...
def date_shift_evaluation(output_directory,date_shift_log_i2b2,date_shift_log,problem_files_log):
	...
	output_eval["description"] = output_eval['classification'].replace({'true positive':'appears in both i2b2 and philter','false positive':'appears in automatically philtered notes only', 'false negative':'appears in manually annotated notes only'})
