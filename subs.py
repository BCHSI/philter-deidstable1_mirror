...
class Subs:
    ...
    def _load_look_up_mongo(self, filenames, db):
        ...
        for filename in filenames:
          ...
          id2offset***REMOVED***filename***REMOVED***  = surrogate_info***REMOVED***"deid_date_offset_cdw"***REMOVED***
          id2deid***REMOVED***filename***REMOVED*** = surrogate_info***REMOVED***"_id"***REMOVED***        
