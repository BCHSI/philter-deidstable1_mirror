...
class Phitexts:
    ...
    def print_log(self, output_dir, kp, xml):
        ...
        for filename in self.filenames:
            ...
            if xml:
               total_tokens = len(Knownphi._get_clean(self.texts***REMOVED***filename***REMOVED***)) 
    ...
    def _get_fulltext_dicts(self, gold_dicts, philter_dicts):
        fulltext_dicts = {}
        for filename in gold_dicts:
            fulltext_dicts***REMOVED***filename***REMOVED*** = Knownphi._get_tokens(self.texts***REMOVED***filename***REMOVED***)
