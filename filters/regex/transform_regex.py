...
#state_names = "***REMOVED***Aa***REMOVED***rizona|AZ|***REMOVED***Vv***REMOVED***irginia|VA|***REMOVED***Mm***REMOVED***innesota|MN|***REMOVED***Aa***REMOVED***laska|AK|***REMOVED***Nn***REMOVED***ew ***REMOVED***Yy***REMOVED***ork|NY|***REMOVED***Tt***REMOVED***exas|TX|***REMOVED***Vv***REMOVED***ermont|VT|***REMOVED***Uu***REMOVED***tah|UT|***REMOVED***Nn***REMOVED***ew ***REMOVED***Jj***REMOVED***ersey|NJ|***REMOVED***Nn***REMOVED***orth ***REMOVED***Dd***REMOVED***akota|ND|***REMOVED***Ss***REMOVED***outh ***REMOVED***Dd***REMOVED***akota|SD|***REMOVED***Mm***REMOVED***issouri|MO|***REMOVED***Ww***REMOVED***ashington ***REMOVED***Dd***REMOVED***\.***REMOVED***Cc***REMOVED***\.|***REMOVED***Gg***REMOVED***eorgia|GA|***REMOVED***Mm***REMOVED***assachusetts|MA|***REMOVED***Pp***REMOVED***uerto ***REMOVED***Rr***REMOVED***ico|***REMOVED***Mm***REMOVED***ichigan|MI|***REMOVED***Ii***REMOVED***owa|IA|***REMOVED***Nn***REMOVED***orth ***REMOVED***Cc***REMOVED***arolina|NC|***REMOVED***Ss***REMOVED***outh ***REMOVED***Cc***REMOVED***arolina|SC|***REMOVED***Nn***REMOVED***evada|NV|***REMOVED***Cc***REMOVED***olorado|CO|***REMOVED***Oo***REMOVED***hio|OH|***REMOVED***Hh***REMOVED***awaii|HI|***REMOVED***Nn***REMOVED***ebraska|NE|***REMOVED***Nn***REMOVED***ew ***REMOVED***Hh***REMOVED***ampshire|NH|***REMOVED***Ww***REMOVED***ashington|WA|***REMOVED***Tt***REMOVED***ennessee|TN|***REMOVED***Aa***REMOVED***rkansas|AR|***REMOVED***Ll***REMOVED***ouisiana|LA|***REMOVED***Mm***REMOVED***ississippi|MS|***REMOVED***Oo***REMOVED***regon|OR|***REMOVED***Aa***REMOVED***labama|AL|***REMOVED***Ww***REMOVED***yoming|WY|***REMOVED***Ww***REMOVED***isconsin|WI|***REMOVED***Oo***REMOVED***klahoma|OK|***REMOVED***Ff***REMOVED***lorida|FL|***REMOVED***Rr***REMOVED***hode ***REMOVED***Ii***REMOVED***sland|RI|***REMOVED***Ii***REMOVED***ndiana|IN|***REMOVED***Cc***REMOVED***alifornia|CA|***REMOVED***Kk***REMOVED***ansas|KS|***REMOVED***Dd***REMOVED***elaware|DE|***REMOVED***Mm***REMOVED***aryland|***REMOVED***Ii***REMOVED***daho|ID|***REMOVED***Pp***REMOVED***ennsylvania|PA|***REMOVED***Kk***REMOVED***entucky|KY|***REMOVED***Cc***REMOVED***onnecticut|CT|***REMOVED***Mm***REMOVED***ontana|MT|***REMOVED***Ii***REMOVED***llinois|IL|***REMOVED***Mm***REMOVED***aine|ME"
...
# person_names = person_names***REMOVED***:-1***REMOVED***
