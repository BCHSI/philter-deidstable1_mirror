...
import re 
import pickle
from philter_stanford_pos import Philter
import gzip
import json
...
def main():
    ...
    ap.add_argument("--stanfordner", default="/usr/local/stanford-ner/",
                    ...
                    type=str)
    ap.add_argument("--stanfordpos", default="/usr/local/stanford-ner/",
                    help="Path to Stanford POS, the default is /usr/local/stanford-ner/",
                    type=str)
    ...
    philter_config = {
        ...
        "stanford_pos_tagger": { 
            "model":args.stanfordpos+"models/english-bidirectional-distsim.tagger",
            "jar":args.stanfordpos+"stanford-postagger.jar",
            "download":True,
        }
    }    
