...
class Subs:
    ...
    def _load_look_up_table(self,note_info_path, re_id_pat_path, note_keys):
        ...
        note_info = dd.read_csv(note_info_path, sep='\t', usecols=***REMOVED***'patient_ID', 'note_key'***REMOVED***)
        re_id_pat = dd.read_csv(re_id_pat_path, sep='\t', usecols=***REMOVED***'PatientId', 'date_offset'***REMOVED***)
