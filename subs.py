...
class Subs:
    ...
    def get_shift_amount(self,note_id):
        return self.shift_table***REMOVED***note_id***REMOVED***
    ...
    def _load_look_up_table(self,note_info_path,re_id_pat_path):
        ...
        note_info = pd.read_csv(note_info_path, sep='\t', usecols=***REMOVED***'patient_ID', 'note_key'***REMOVED***)
        re_id_pat = pd.read_csv(re_id_pat_path, sep='\t', usecols=***REMOVED***'PatientId', 'date_offset'***REMOVED***)
