...
class Philter:
    ...
    def __init__(self, config):
        ...
        if "stanford_pos_tagger" in config:
            if not os.path.exists(config***REMOVED***"stanford_pos_tagger"***REMOVED******REMOVED***"model"***REMOVED***) and config***REMOVED***"stanford_pos_tagger"***REMOVED******REMOVED***"download"***REMOVED*** == False:
                raise Exception("Filepath does not exist", config***REMOVED***"stanford_pos_tagger"***REMOVED******REMOVED***"model"***REMOVED***)
            else:
                #download the ner data
                process = subprocess.Popen("cd generate_dataset && ./download_ner.sh".split(), stdout=subprocess.PIPE)
                output, error = process.communicate()
            self.stanford_pos_tagger_model = config***REMOVED***"stanford_pos_tagger"***REMOVED******REMOVED***"model"***REMOVED***
            if not os.path.exists(config***REMOVED***"stanford_pos_tagger"***REMOVED******REMOVED***"jar"***REMOVED***):
                raise Exception("Filepath does not exist", config***REMOVED***"stanford_pos_tagger"***REMOVED******REMOVED***"jar"***REMOVED***)
            self.stanford_pos_tagger_jar = config***REMOVED***"stanford_pos_tagger"***REMOVED******REMOVED***"jar"***REMOVED***
                #we lazy load our tagger only if there's a corresponding pattern
