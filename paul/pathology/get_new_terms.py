# extracts terms which match ***REMOVED***A-Z0-9\-***REMOVED*** from two .tsv files provided by Dima (Dmytro) Lituiev
...
def extract(fin1, fin2):
    ...
    symbols_pattern = re.compile("***REMOVED***A-Z***REMOVED******REMOVED***A-Z0-9\-***REMOVED***+") # regex for catching new terms
    ...
    for symbol in f1_symbols: #
        ...
        if symbol not in symbols_list:
            symbols_list***REMOVED***symbol***REMOVED*** = 1
    ...
    del symbols_list***REMOVED***"HGNC"***REMOVED***
    del symbols_list***REMOVED***"ID"***REMOVED***
    del symbols_list***REMOVED***"CUI"***REMOVED***
    del symbols_list***REMOVED***"AUI"***REMOVED***
    del symbols_list***REMOVED***"STT"***REMOVED***
    del symbols_list***REMOVED***"ISPREF"***REMOVED***
    del symbols_list***REMOVED***"SAB"***REMOVED***
    del symbols_list***REMOVED***"TTY"***REMOVED***
...
def append(symbols_list, wl_name, format):
    ...
    new_wl = wl_name***REMOVED***:-(len(format)+1)***REMOVED***+"_new."+format
    ...
    for symbol in symbols_list:
        if symbol not in big_list:
            if format == "json":
                big_list***REMOVED***symbol***REMOVED*** = 1
            elif format == "txt":
