...
def compare(ogdir, wldir, path_name, name_lines, symbols):
    ...
    for filepath in path_name:
        ...
        for line in name_lines***REMOVED***name***REMOVED***:
            og_line = original***REMOVED***int(line)-1***REMOVED***
            wl_line = whitelist***REMOVED***int(line)-1***REMOVED***
            ...
            for smb in symbols:
                ...
                if not re.search(term, og_line):
                    if re.search(term, wl_line):
                        ...
                        # output
                        s = "'" + smb + "' was recovered in '" + path_name***REMOVED***filepath***REMOVED*** + "' on line '" + line + "' : \"" + wl_line + "\""
