...
def parse(inputfilename):
    ...
    newtext = ***REMOVED******REMOVED***

    for i in range(len(text)):
        line = text***REMOVED***i***REMOVED***
        ...
        # if line is "regex is re.compile()"
            ...
            # get values in line
            exp = re.search('regex is (***REMOVED***a-zA-Z***REMOVED***+?\.***REMOVED***a-zA-Z***REMOVED***+?\(***REMOVED***\s\S***REMOVED***+\))', line).group(1)
        ...
        # if line is "match object"
            ...
            # get values in line
            word = re.search('match=***REMOVED***\'|\"***REMOVED***(.+?)***REMOVED***\'|\"***REMOVED***\>', line).group(1)
...
def main():
    ...
    fout = fin***REMOVED***:-4***REMOVED***+"_transformed.txt"
